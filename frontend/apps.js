cat << 'EOF' > ~/dj-booking-platform/frontend/src/App.js
...
function App() {
  ...
  const handleRegisterAndBook = async (e) => {
    ...
    try {
      ...
      alert("Error reaching backend server. Ensure backend is running on port 5000.");
    } finally {
      setLoading(false);
    }
  };
